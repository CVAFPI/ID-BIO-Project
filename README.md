# 🛡️ CVAFPI IDENTIFICATION SYSTEM
...
Setup & Installation (Debian 13 KDE)
...
3. Grant Script Execution Permissions
 Grants the app launcher permissions to open it
...
⚙️ Setting Up Auto-Start on Boot (KDE Plasma)
