 ...
 * Navigate to Autostart (under Workspace).
 * Click Add... -> Add Application or Script...
 * Select the id_bio.desktop file located inside your project folder.
 ...
 * Email Us Directly: Send an email to allthingslinux2026@gmail.com
   * What to attach: Your school's logo (PNG or JPEG format), your school name, and any specific color or design requests.
 * Open a GitHub Issue: Visit our GitHub Issues Page and click New Issue.
